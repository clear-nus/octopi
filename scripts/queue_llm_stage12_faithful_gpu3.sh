...
SEED="${SEED:-0}"
STAGE1_CUDA="${STAGE1_CUDA:-3}"
STAGE2_CUDA="${STAGE2_CUDA:-3}"
STAGE1_GPU_CONFIG="${STAGE1_GPU_CONFIG:-configs/gpu_config_7b_gpu3.json}"
STAGE2_GPU_CONFIG="${STAGE2_GPU_CONFIG:-configs/gpu_config_7b_gpu3.json}"
...
STAGE1_EXP_ID="fp0_d24_s1_faithful_8000_gpu3"
LORA_EXP_ID="fp0_d24_s2_faithful_qk_lr2e4_3000_gpu3"
