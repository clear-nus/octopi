...
WAIT_SESSION="${WAIT_SESSION:-octopi_llm_trainproj_lr2e4_qkv_then_qk}"
SEED="${SEED:-0}"
...
STAGE1_EXP_ID="full_pipeline_${SEED}_frames8_depth24enc_fullloss_stage1_8000_finalonly_lr2e-5_${RUN_TAG}"
LORA_EXP_ID="full_pipeline_${SEED}_frames8_depth24enc_stage1_8000final_lora_qkv_r128_a256_lr0.0001_trainproj2e-5_finalonly_originalpom_reasonconcl0.25_pom0.5_cons0.02_3000_${RUN_TAG}"
