...
SEED="${SEED:-0}"
STAGE1_CUDA="${STAGE1_CUDA:-6}"
STAGE2_CUDA="${STAGE2_CUDA:-6}"
STAGE1_GPU_CONFIG="${STAGE1_GPU_CONFIG:-configs/gpu_config_7b_gpu6.json}"
...
STAGE1_EXP_ID="fp0_d24_s1_vidx_trainall_8000_gpu6"
LORA_EXP_ID="fp0_d24_s2_vidx_3000_gpu6"
