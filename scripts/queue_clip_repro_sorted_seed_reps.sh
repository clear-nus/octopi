#!/bin/bash
# Encoder-only seed repeat for the final reproducible sorted-order CLIP config.
...
CONFIG_BAK="${CONFIG}.repro_sorted_seed_reps_bak"
DATASET_PATH="dataset"
DATA_ROOT="data/clip_repro_sorted_seed_reps"
SUMMARY="clip_seed_reps_repro_sorted_valmean_ema098.txt"
CSV="${SUMMARY}.csv"
...
run_seed() {
  local seed="$1" exp_id="clip_seed_${seed}_repro_sorted_valmean_ema098"
