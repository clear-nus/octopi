...
STAGE1_DIR="${STAGE1_DIR:-exps/2026_06_18_17_02_24_train_llm_train_vicuna-7b_8000_fp0_d24_s1_full_noaux_8000_gpu7}"
LORA_EXP_ID="fp${SEED}_d24_s2_opdcons05_${STEPS}_gpu6"
...
set_cfg "$STAGE2_CONFIG" \
        ...
        --key opd_consistency_loss_weight --value 0.5 \
