...
SEED="${SEED:-0}"
STAGE1_CUDA="${STAGE1_CUDA:-0}"
STAGE2_CUDA="${STAGE2_CUDA:-0}"
STAGE1_GPU_CONFIG="${STAGE1_GPU_CONFIG:-configs/gpu_config_7b_gpu0.json}"
STAGE2_GPU_CONFIG="${STAGE2_GPU_CONFIG:-configs/gpu_config_7b_gpu0.json}"
...
STAGE1_EXP_ID="fp0_d24_s1_vidx2_trainall_8000_gpu0"
LORA_EXP_ID="fp0_d24_s2_vidx2_3000_gpu0"
...
set_cfg "$STAGE1_CONFIG" \
        ...
        --key video_index_embedding --value True \
