...
# label_smoothing=0.1 and EMA enabled.
...
CONFIG_BAK="${CONFIG}.smooth01_ema_seed_reps_bak"
DATASET_PATH="dataset"
DATA_DIR="data"
SUMMARY="clip_seed_reps_smooth01_ema098.txt"
CSV="${SUMMARY}.csv"
...
run_seed() {
  local seed="$1" exp_id="clip_seed_${seed}_smooth01_ema098"
